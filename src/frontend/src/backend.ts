...
export class Backend implements backendInterface {
    ...
    async getDailyGoals(arg0: string): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyGoals(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getTaskStates(arg0: string): Promise<Array<[string, boolean]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTaskStates(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async resetTasks(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetTasks(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setDailyGoals(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setDailyGoals(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async toggleTask(arg0: string, arg1: string): Promise<boolean> {
        if (this.processError) {
            try {
